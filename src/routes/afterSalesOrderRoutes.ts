...
router
  .route('/')
  .get(protect, allow([ROLES.Admin, ROLES.Customer, ROLES.CustomerService, ROLES.OrderPlacer, ROLES.Reviewer]), getAfterSalesOrders)  // Get list of after sales orders
