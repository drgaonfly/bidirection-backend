...
const seedUsers = [
  ...
  {
    email: 'orderplacer@2024fc.xyz',
    password: 'orderplacer2024',
    role: ROLES.OrderPlacer,
    name: 'Order Placer',
  },
  {
    email: 'reviewer@2024fc.xyz',
    password: 'reviewer2024',
    role: ROLES.Reviewer,
    name: 'Reviewer',
  },
  {
    email: 'customerservice@2024fc.xyz',
    password: 'customerservice2024',
    role: ROLES.CustomerService,
    name: 'Customer Service',
  },
  {
    email: 'admin@2024fc.xyz',
