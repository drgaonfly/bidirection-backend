...
router.post('/', protect, allow([ROLES.Admin, ROLES.CustomerService, ROLES.OrderPlacer]), createAccountAssignmentRecord);
router.get('/', protect, allow([ROLES.Admin, ROLES.CustomerService, ROLES.OrderPlacer]), getAllAccountAssignmentRecords);
